...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        torch.cuda.synchronize() 
        endtime = time() 
        print("full time taken for a single forward pass {}".format((endtime - starttime)/1000)) 
        ...
        while (length_inputids - initial_len) < 80: 
            ...
            if (length_inputids - last_check) != kernel_size: 
                ...
                starttime = time() 
                executingcachepositionsparseco = executingcachepositionsparse.clone() 
                for i in range(1000): 
                    ...
                    ''' 
                    executingcachepositionsparse.copy_(executingcachepositionsparseco - step + 1) 
